...
<head>
    ...
    <title>OTP Verification - Purple Admin</title>
                ...
                <div class="row flex-grow">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <h6 class="font-weight-light text-center mb-4">Enter the 6-digit code sent to your email.</h6>
                            ...
                            <form class="pt-3" method="POST" action="{{ route('otp.verify') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="otp_input" id="otp_full">
                                    
                                    @if($errors->has('otp_error'))
                                        <div class="text-danger text-center mt-3">{{ $errors->first('otp_error') }}</div>
                                    @endif
                                </div>
                                ...
                                <div class="text-center mt-4 font-weight-light"> 
                                    Didn't receive a code? <a href="#" class="text-primary">Resend</a>
                                </div>
                            </form>
                        </div>
                    </div>
